...
<package-comment/>
<businessobject displayString="FenergoLegalEntity" type="com.j2fe.processing.BusinessFeed">
...
<description id="4">Legal Entity message from Fenergo</description>
...
<isVDDB>false</isVDDB>
<mappingResource id="10">db://resource/mapping/Mizuho/LegalEntityInbound.mdx</mappingResource>
<metaData id="11" type="java.util.HashMap"/>
<name id="12">LEGALENTITY</name>
...
<name id="16">FenergoLegalEntity</name>
