...
<goldensource-package version="10.0.0.02">
    <package-comment/>
    <businessobject displayString="Bloomberg_Credit_Risk" type="com.j2fe.processing.BusinessFeed">
        <com.j2fe.processing.BusinessFeed id="0">
            ...
            <fileDefinitions id="5" type="java.util.ArrayList">
                <item id="6" type="com.j2fe.processing.FileDefinition">
                    <file id="7">credit_risk.out.gz.enc.20*</file>
                    <group id="8">1</group>
                    <messageType id="9">
                        ...
                        <isVDDB>true</isVDDB>
                        <mappingResource id="13">db://resource/mapping/Bloomberg/BBCreditRisk.omdx</mappingResource>
                        <metaData id="14" type="java.util.HashMap"/>
                        <name id="15">BBCreditRisk</name>
                ...
                <item id="19" type="com.j2fe.processing.FileDefinition">
                    <file id="20">credit_risk.diff.gz.enc.20*</file>
                    <group id="21">2</group>
                    <messageType idref="9"/>
                </item>
                <item id="22" type="com.j2fe.processing.FileDefinition">
                    <file id="23">credit_risk.out.gz.20*</file>
                    <group idref="8"/>
                    <messageType idref="9"/>
                </item>
                <item id="24" type="com.j2fe.processing.FileDefinition">
                    <file id="25">credit_risk.dif.gz.20*</file>
                    <group idref="21"/>
                    <messageType idref="9"/>
                </item>
            </fileDefinitions>
            ...
            <name id="27">Bloomberg_Credit_Risk</name>
